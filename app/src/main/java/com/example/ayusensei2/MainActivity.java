...
import com.example.ayusensei2.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main); // Make sure you're setting the correct layout file

        // Find the button by its ID and set up a click listener
        Button btnGetStarted = findViewById(R.id.btngetstarted); // Ensure this matches your Button ID
